        ...
        <div className="h-16 bg-[#f0f4f8] shrink-0 flex items-center justify-between px-4 lg:px-8 z-10">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-gray-200 cursor-pointer group">
              <div className="relative">
                <img
                  src={`https://ui-avatars.com/api/?name=${admin?.name || 'John Admin'}&background=1e5cdc&color=fff&bold=true`}
                  alt="Admin"
              ...
              <div className="hidden sm:flex items-center gap-2">
                <div className="text-left">
                  ...
                  <div className="text-[9px] font-bold text-gray-400 uppercase tracking-wider">
                    {location.pathname === '/admin/submissions' ? 'Submission Reviewer' : 'Super Admin'}
                  </div>
                </div>
