export const CONTRACT_CATEGORIES = {
  'Employment & HR Contracts': [
    ...
    'Exit & Full-and-Final Settlement Agreement'
  ],
  ...
  'Educational & Training Agreements': [
    'Training Agreement',
    'Educational Partnership Agreement',
    'Research Collaboration Agreement',
    'Internship MoU',
    'Certification Agreement',
    'Academic Consultancy Agreement'
  ],
  'Project Management & Operations Contracts': [
    'Project Agreement',
